  ...
  return (
    <div className="max-w-5xl mx-auto anime-fade-in pb-20">
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-3xl font-black text-surface-900 tracking-tight">Create Invoice</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white rounded-[2rem] border border-surface-200 p-8 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-xs font-black uppercase text-surface-400 mb-2 ml-1">Select Customer</label>
                <select
              ...
              <div>
                <label className="block text-xs font-black uppercase text-surface-400 mb-2 ml-1">Invoice Date</label>
                <input
                  type="date"
          ...
          <div className="bg-white rounded-[2rem] border border-surface-200 p-8 shadow-sm">
            ...
            >
              <span className="group-hover:scale-110 inline-block mr-2">+</span> Add Line Item
            </button>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="bg-surface-900 rounded-[2rem] p-8 text-white shadow-xl sticky top-24">
            <h2 className="font-bold text-lg mb-6 border-b border-white/10 pb-4">Invoice Summary</h2>
            ...
            <div className="mt-10 space-y-4">
              <div>
                <label className="block text-[10px] font-black uppercase text-white/40 mb-2">Payment Status</label>
              ...
              >
                {saving ? 'Generating...' : 'Save & Finalize →'}
              </button>
            </div>
          </div>
        </div>
