  ...
  if (invoices.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center">
        ...
        <p className="text-surface-500 font-medium">No invoices found. <br/>Start by creating your first invoice.</p>
        <Link 
      ...
      <table className="w-full text-left border-collapse min-w-[800px]">
        <thead>
          <tr className="border-b border-surface-100 bg-surface-50/50">
            <th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-surface-400">Invoice No.</th>
            <th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-surface-400">Customer</th>
            <th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-surface-400">Date</th>
            <th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-surface-400">Amount</th>
            <th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-surface-400">Status</th>
            <th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-surface-400 text-right">Actions</th>
          </tr>
        </thead>
